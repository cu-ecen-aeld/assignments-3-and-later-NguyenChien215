...
struct thread_data{
     ...
     */
    pthread_mutex_t *mutex; //obtain mutex
    int wait_to_obtain_ms; // sleep number of milliseconds then obtains the mutex
    int wait_to_release_ms; // Hold a number of millisecond then release the mutex
